...
# Inside calculate_score() check for a blackjack (a hand with only 2 cards: ace(11) + 10) and return 0 instead of the actual score. 0 will represent a blackjack in our game.
...
def calculate_score(cards):
    """Calculates if score is below, equal to """
...
calculate_score()
if computer_cards or user_cards == 0 or if user_cards > 21:
    print("You lose!")
