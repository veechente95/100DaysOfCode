...
# Create a function called calculate_score() that takes a List of cards as input and returns the score. Look up the sum() function to help you do this.
# Inside calculate_score() check for a blackjack (a hand with only 2 cards: ace + 10) and return 0 instead of the actual score. 0 will represent a blackjack in our game.
# Inside calculate_score() check for an 11 (ace). If the score is already over 21, remove the 11 and replace it with aa 1. You might need to look up append() and remove().
...
# Define function called play game and print logo
...
def play_game():
    ...
    while not is_game_over:
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            draw_again = str(input("Type 'y' to get another card, type 'n' to pass:")).lower()
            if draw_again == 'y':
                user_cards.append(deal_card())
            else:
                is_game_over = True
