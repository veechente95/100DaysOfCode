...
# Hint 8: Inside calculate_score() check for an 11 (ace). If the score is already over 21, remove the 11 and replace it with aa 1. You might need to look up append() and remove().
...
# Hint: Define function called play game and print logo
